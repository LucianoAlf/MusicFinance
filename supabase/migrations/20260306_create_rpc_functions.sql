-- Migration: Criar funções RPC para otimizar performance
-- Reduz 15 queries HTTP para 2 chamadas RPC

-- Função 1: get_school_dashboard
-- Substitui as 12 queries do loadSchoolData
...
-- Função 2: get_school_kpis
-- Substitui as 3 queries de views
